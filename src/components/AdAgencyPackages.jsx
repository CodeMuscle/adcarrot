          ...
          >
            <div className="flex flex-col items-center justify-between md:flex-row md:items-start">
              <div className="mb-6 flex flex-col md:mb-0 md:w-1/2">
                ...
                <p className="mb-2 text-5xl font-bold">{pack.price}</p>
                <p className="px-2">{pack.description}</p>
              </div>
              ...
              <div className="flex flex-col md:w-1/2">
                ...
                <div className="">
                  <button
                    type="button"
                    className="flex items-center gap-2 rounded-full bg-emerald-950 px-4 py-2 text-orange-50 hover:bg-emerald-900"
                  >
